...
using hms::OeeService::OeeInput;
using hms::OeeService::computeOee;

// 全满负荷 + 全合格: OEE = 100%
TEST(OeeCalc, PerfectLine) {
    OeeInput in{.runSeconds = 28800, .plannedSeconds = 28800, .reportSeconds = 28800,
                .passQty = 100, .defectQty = 0};
...
TEST(OeeCalc, ClassicFactors) {
    OeeInput in{.runSeconds = 25920, .plannedSeconds = 28800, .reportSeconds = 24624,
                .passQty = 999, .defectQty = 1};
    auto r = computeOee(in);
...
TEST(OeeCalc, NoPlanZeroOee) {
    OeeInput in{.runSeconds = 3600, .plannedSeconds = 0, .reportSeconds = 3600,
                .passQty = 100, .defectQty = 0};
    auto r = computeOee(in);
...
TEST(OeeCalc, NoRunData) {
    OeeInput in{.runSeconds = 0, .plannedSeconds = 28800, .reportSeconds = 0,
                .passQty = 50, .defectQty = 50};
    auto r = computeOee(in);
    EXPECT_DOUBLE_EQ(r.availability, 0.0);
...
TEST(OeeCalc, PerformanceCappedAtOne) {
    OeeInput in{.runSeconds = 10000, .plannedSeconds = 28800, .reportSeconds = 15000,
                .passQty = 100, .defectQty = 0};
    auto r = computeOee(in);
    EXPECT_DOUBLE_EQ(r.performance, 1.0);
...
TEST(OeeCalc, AvailabilityCappedAtOne) {
    OeeInput in{.runSeconds = 30000, .plannedSeconds = 28800, .reportSeconds = 10000,
                .passQty = 100, .defectQty = 0};
    auto r = computeOee(in);
    EXPECT_DOUBLE_EQ(r.availability, 1.0);
}
...
TEST(OeeCalc, NegativeInputClamped) {
    OeeInput in{.runSeconds = -100, .plannedSeconds = 28800, .reportSeconds = -5,
                .passQty = -1, .defectQty = 0};
    auto r = computeOee(in);
    EXPECT_DOUBLE_EQ(r.availability, 0.0);
    EXPECT_DOUBLE_EQ(r.performance, 0.0);
    EXPECT_DOUBLE_EQ(r.oee, 0.0);
...
TEST(OeeCalc, ManualVerificationSample1) {
    OeeInput in{.runSeconds = 27000, .plannedSeconds = 28800, .reportSeconds = 24300,
                .passQty = 950, .defectQty = 50};
    auto r = computeOee(in);
...
TEST(OeeCalc, ManualVerificationSample2) {
    OeeInput in{.runSeconds = 14400, .plannedSeconds = 28800, .reportSeconds = 10800,
                .passQty = 500, .defectQty = 0};
    auto r = computeOee(in);
...
TEST(OeeCalc, ManualVerificationSample3) {
    OeeInput in{.runSeconds = 28800, .plannedSeconds = 28800, .reportSeconds = 17280,
                .passQty = 900, .defectQty = 100};
    auto r = computeOee(in);
