 ...
 * algoritmes either don't conflict with each other in their use of the
 * data area or reset the initialized field themselves whenever required.
 * Currently, the hashing algoritmes simply have no conflicts: the first
 ...
 * hashing algoritmes use less than 128 bytes of the data area.
 */
